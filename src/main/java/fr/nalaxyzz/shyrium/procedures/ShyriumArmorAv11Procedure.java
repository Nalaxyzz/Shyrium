...
import fr.nalaxyzz.shyrium.item.ShyriumArmorBasicItem;
import fr.nalaxyzz.shyrium.ShyriumMod;

public class ShyriumArmorAv11Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ShyriumMod.LOGGER.warn("Failed to load dependency entity for procedure ShyriumArmorAv11!");
			return;
		}
