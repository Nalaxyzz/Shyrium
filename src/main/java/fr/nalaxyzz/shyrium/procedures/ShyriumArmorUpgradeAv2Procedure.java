...
import fr.nalaxyzz.shyrium.item.ShyriumUpgradeItem;
import fr.nalaxyzz.shyrium.ShyriumMod;

public class ShyriumArmorUpgradeAv2Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ShyriumMod.LOGGER.warn("Failed to load dependency entity for procedure ShyriumArmorUpgradeAv2!");
			return;
		}
