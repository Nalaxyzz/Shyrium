...
public class ShyriumArmorBasicBootsTickEventProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ShyriumMod.LOGGER.warn("Failed to load dependency entity for procedure ShyriumArmorBasicBootsTickEvent!");
			return;
		}
