...
public class ShyriumOreNetherBlock extends ShyriumModElements.ModElement {
	@ObjectHolder("shyrium:shyrium_ore_nether")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("shyrium:shyrium_ore_nether_match"),
