...
import fr.nalaxyzz.shyrium.item.MalachitegemItem;
...
public class MalachiteoreBlock extends ShyriumModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("shyrium:malachiteore_match"), () -> CustomRuleTest.codec);
