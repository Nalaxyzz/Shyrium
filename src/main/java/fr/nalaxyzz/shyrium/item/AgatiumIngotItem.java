...
public class AgatiumIngotItem extends ShyriumModElements.ModElement {
	@ObjectHolder("shyrium:agatium_ingot")
	public static final Item block = null;

	public AgatiumIngotItem(ShyriumModElements instance) {
		super(instance, 18);
	}
