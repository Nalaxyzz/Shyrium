...
public class AgatiumrawItem extends ShyriumModElements.ModElement {
	@ObjectHolder("shyrium:agatiumraw")
	public static final Item block = null;

	public AgatiumrawItem(ShyriumModElements instance) {
		super(instance, 30);
	}
